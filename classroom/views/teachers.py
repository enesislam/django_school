...
class QuizCreateView(CreateView):
    ...
    def form_valid(self, form):
        ...
        quiz.save()
        messages.success(self.request, 'Sınav başarı ile oluşturuldu! Şimdi biraz soru ekle :).')
...
class QuizDeleteView(DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        messages.success(request, 'Sınav %s silindi' % quiz.name)
...
def question_add(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            question.quiz = quiz
            question.save()
            messages.success(request, 'Şimdi cevapları/seçenekleri soruya ekleyebilirsin.')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid() and formset.is_valid():
            with transaction.atomic():
                form.save()
                formset.save()
            messages.success(request, 'Soru ve cevaplar kaydedildi!')
            return redirect('teachers:quiz_change', quiz.pk)
    else:
...
class QuestionDeleteView(DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        question = self.get_object()
        messages.success(request, 'Soru %ssilindi!' % question.text)
        return super().delete(request, *args, **kwargs)
